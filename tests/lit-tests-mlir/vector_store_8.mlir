...
module {
    ...
    {
        vector.store %value, %base[%i, %j] {nontemporal = true} : memref<100x100xf32>, vector<f32>
        func.return
    }
}
...
// CHECK_CAN:           vector.store %arg0, %arg1[%arg2, %arg3] {nontemporal = true} : memref<100x100xf32>, vector<f32>
// CHECK_CAN:           return
// CHECK_CAN:       }
// CHECK_CAN:   }
...
// CHECK_GEN:           "vector.store"(%arg0, %arg1, %arg2, %arg3) <{nontemporal = true}> : (vector<f32>, memref<100x100xf32>, index, index) -> ()
