...
module {
    func.func @test(%a: tensor<8x16xi64>, %b: tensor<8x16xi64>) -> tensor<8x16xi64>
    {
        ...
        %out0 = linalg.div ins(%a, %b: tensor<8x16xi64>, tensor<8x16xi64>) outs(%out: tensor<8x16xi64>) -> tensor<8x16xi64>
...
// CHECK_CAN:           %1 = linalg.div ins(%arg0, %arg1 : tensor<8x16xi64>, tensor<8x16xi64>) outs(%0 : tensor<8x16xi64>) -> tensor<8x16xi64>
...
// CHECK_GEN:               %2 = "arith.divsi"(%arg2, %arg3) : (i64, i64) -> i64
