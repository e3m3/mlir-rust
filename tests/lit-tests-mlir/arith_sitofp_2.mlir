...
module {
    ...
    {
        %out = arith.sitofp %in : vector<10xi64> to vector<10xf64>
...
// CHECK_CAN:           %0 = arith.sitofp %arg0 : vector<10xi64> to vector<10xf64>
...
// CHECK_GEN:           %0 = "arith.sitofp"(%arg0) : (vector<10xi64>) -> vector<10xf64>
