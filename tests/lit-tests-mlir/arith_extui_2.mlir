...
module {
    ...
    {
        %out = arith.extui %in : vector<10xi32> to vector<10xi64>
...
// CHECK_CAN:           %0 = arith.extui %arg0 : vector<10xi32> to vector<10xi64>
...
// CHECK_GEN:           %0 = "arith.extui"(%arg0) : (vector<10xi32>) -> vector<10xi64>
