...
module {
    ...
    {
        %v0 = vector.load %base[%i, %j] : memref<100x100xf32>, vector<f32>
...
// CHECK_CAN:           %0 = vector.load %arg0[%arg1, %arg2] : memref<100x100xf32>, vector<f32>
...
// CHECK_GEN:           %0 = "vector.load"(%arg0, %arg1, %arg2) : (memref<100x100xf32>, index, index) -> vector<f32>
