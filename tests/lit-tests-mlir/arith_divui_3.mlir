...
module {
    ...
    {
        %out = arith.divui %a, %b : vector<10xi32>
...
// CHECK_CAN:           %0 = arith.divui %arg0, %arg1 : vector<10xi32>
...
// CHECK_GEN:           %0 = "arith.divui"(%arg0, %arg1) : (vector<10xi32>, vector<10xi32>) -> vector<10xi32>
