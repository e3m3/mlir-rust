...
module {
    func.func @test(%a: tensor<8x16xi64>, %b: tensor<8x16xi64>) -> tensor<8x16xi64>
    {
        ...
        %out0 = linalg.div_unsigned ins(%a, %b: tensor<8x16xi64>, tensor<8x16xi64>) outs(%out: tensor<8x16xi64>) -> tensor<8x16xi64>
...
// CHECK_CAN:           %1 = linalg.div_unsigned ins(%arg0, %arg1 : tensor<8x16xi64>, tensor<8x16xi64>) outs(%0 : tensor<8x16xi64>) -> tensor<8x16xi64>
...
// CHECK_GEN:           %1 = "linalg.div_unsigned"(%arg0, %arg1, %0) <{operandSegmentSizes = array<i32: 2, 1>}> ({
// CHECK_GEN:           ^bb0(%arg2: i64, %arg3: i64, %arg4: i64):
// CHECK_GEN:               %2 = "arith.divui"(%arg2, %arg3) : (i64, i64) -> i64
