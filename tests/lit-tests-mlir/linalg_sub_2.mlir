...
module {
    func.func @test(%a: memref<8x16xf32>, %b: memref<8x16xf32>) -> memref<8x16xf32>
    {
        ...
        linalg.sub ins(%a, %b: memref<8x16xf32>, memref<8x16xf32>) outs(%out: memref<8x16xf32>)
...
// CHECK_CAN:           linalg.sub ins(%arg0, %arg1 : memref<8x16xf32>, memref<8x16xf32>) outs(%alloc : memref<8x16xf32>)
...
// CHECK_GEN:               %1 = "arith.subf"(%arg2, %arg3) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
