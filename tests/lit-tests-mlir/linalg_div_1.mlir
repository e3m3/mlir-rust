...
module {
    func.func @test(%a: tensor<8x16xf32>, %b: tensor<8x16xf32>) -> tensor<8x16xf32>
    {
        ...
        %out0 = linalg.div ins(%a, %b: tensor<8x16xf32>, tensor<8x16xf32>) outs(%out: tensor<8x16xf32>) -> tensor<8x16xf32>
...
// CHECK_CAN:           %1 = linalg.div ins(%arg0, %arg1 : tensor<8x16xf32>, tensor<8x16xf32>) outs(%0 : tensor<8x16xf32>) -> tensor<8x16xf32>
...
// CHECK_GEN:           %1 = "linalg.div"(%arg0, %arg1, %0) <{operandSegmentSizes = array<i32: 2, 1>}> ({
// CHECK_GEN:           ^bb0(%arg2: f32, %arg3: f32, %arg4: f32):
// CHECK_GEN:               %2 = "arith.divf"(%arg2, %arg3) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
