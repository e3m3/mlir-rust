...
module {
    ...
    {
        %out = arith.maxsi %a, %b : tensor<4xi64>
...
// CHECK_CAN:           %0 = arith.maxsi %arg0, %arg1 : tensor<4xi64>
...
// CHECK_GEN:           %0 = "arith.maxsi"(%arg0, %arg1) : (tensor<4xi64>, tensor<4xi64>) -> tensor<4xi64>
