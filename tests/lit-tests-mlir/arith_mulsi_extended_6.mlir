...
module {
    ...
    {
        %low, %high = arith.mulsi_extended %a, %b : tensor<10xindex>
...
// CHECK_CAN:           %low, %high = arith.mulsi_extended %arg0, %arg1 : tensor<10xindex>
...
// CHECK_GEN:           %0:2 = "arith.mulsi_extended"(%arg0, %arg1) : (tensor<10xindex>, tensor<10xindex>) -> (tensor<10xindex>, tensor<10xindex>)
