...
module {
    ...
    {
        %out = arith.remui %a, %b : vector<4xi64>
...
// CHECK_CAN:           %0 = arith.remui %arg0, %arg1 : vector<4xi64>
...
// CHECK_GEN:           %0 = "arith.remui"(%arg0, %arg1) : (vector<4xi64>, vector<4xi64>) -> vector<4xi64>
