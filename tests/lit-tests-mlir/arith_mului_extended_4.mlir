...
module {
    ...
    {
        %low, %high = arith.mului_extended %a, %b : vector<10xindex>
...
// CHECK_CAN:           %low, %high = arith.mului_extended %arg0, %arg1 : vector<10xindex>
...
// CHECK_GEN:           %0:2 = "arith.mului_extended"(%arg0, %arg1) : (vector<10xindex>, vector<10xindex>) -> (vector<10xindex>, vector<10xindex>)
