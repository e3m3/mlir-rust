...
module {
    func.func @test(%a: memref<3x5xf32>, %b: memref<5x7xf32>) -> memref<3x7xf32>
    {
        %out = memref.alloc() : memref<3x7xf32>
        linalg.matmul ins(%a, %b: memref<3x5xf32>, memref<5x7xf32>) outs(%out: memref<3x7xf32>)
        func.return %out : memref<3x7xf32>
    }
}

// CHECK_CAN:   module {
// CHECK_CAN:       func.func @test(%arg0: memref<3x5xf32>, %arg1: memref<5x7xf32>) -> memref<3x7xf32> {
// CHECK_CAN:           %alloc = memref.alloc() : memref<3x7xf32>
// CHECK_CAN:           linalg.matmul ins(%arg0, %arg1 : memref<3x5xf32>, memref<5x7xf32>) outs(%alloc : memref<3x7xf32>)
...
// CHECK_GEN:       "func.func"() <{function_type = (memref<3x5xf32>, memref<5x7xf32>) -> memref<3x7xf32>, sym_name = "test"}> ({
// CHECK_GEN:       ^bb0(%arg0: memref<3x5xf32>, %arg1: memref<5x7xf32>):
...
// CHECK_GEN:           }) {linalg.memoized_indexing_maps = [#map, #map1, #map2]} : (memref<3x5xf32>, memref<5x7xf32>, memref<3x7xf32>) -> ()
// CHECK_GEN:           "func.return"(%0) : (memref<3x7xf32>) -> ()
// CHECK_GEN:       }) : () -> ()
// CHECK_GEN:   }) : () -> ()

// CHECK_AFF:   module {
// CHECK_AFF:       func.func @test(%arg0: memref<3x5xf32>, %arg1: memref<5x7xf32>) -> memref<3x7xf32> {
