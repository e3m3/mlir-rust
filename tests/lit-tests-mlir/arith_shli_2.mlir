...
module {
    ...
    {
        %out = arith.shli %a, %b {overflowFlags = #arith.overflow<nsw,nuw>} : vector<4xi8>
...
// CHECK_CAN:           %0 = arith.shli %arg0, %arg1 overflow<nsw, nuw> : vector<4xi8>
...
// CHECK_GEN:           %0 = "arith.shli"(%arg0, %arg1) <{overflowFlags = #arith.overflow<nsw, nuw>}> : (vector<4xi8>, vector<4xi8>) -> vector<4xi8>
