...
module {
    ...
    {
        %out = arith.divsi %a, %b : tensor<10xindex>
...
// CHECK_CAN:           %0 = arith.divsi %arg0, %arg1 : tensor<10xindex>
...
// CHECK_GEN:           %0 = "arith.divsi"(%arg0, %arg1) : (tensor<10xindex>, tensor<10xindex>) -> tensor<10xindex>
