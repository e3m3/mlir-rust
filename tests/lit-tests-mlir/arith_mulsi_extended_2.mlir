...
module {
    ...
    {
        %low, %high = arith.mulsi_extended %a, %b : index
...
// CHECK_CAN:           %low, %high = arith.mulsi_extended %arg0, %arg1 : index
...
// CHECK_GEN:           %0:2 = "arith.mulsi_extended"(%arg0, %arg1) : (index, index) -> (index, index)
