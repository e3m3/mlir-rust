...
module {
    func.func @test(%a: memref<3xf32>, %b: memref<5x7xf32>) -> memref<3x7xf32>
    {
        ...
        ] } ins(%a, %b: memref<3xf32>, memref<5x7xf32>) outs(%out: memref<3x7xf32>) 
        func.return %out : memref<3x7xf32>
    }
}

// CHECK_CAN:   module {
// CHECK_CAN:       func.func @test(%arg0: memref<3xf32>, %arg1: memref<5x7xf32>) -> memref<3x7xf32> {
// CHECK_CAN:           %alloc = memref.alloc() : memref<3x7xf32>
// CHECK_CAN:           linalg.matmul ins(%arg0, %arg1 : memref<3xf32>, memref<5x7xf32>) outs(%alloc : memref<3x7xf32>)
// CHECK_CAN:           return %alloc : memref<3x7xf32>
// CHECK_CAN:       }
// CHECK_CAN:   }

// CHECK_GEN:   #map = affine_map<(d0, d1, d2) -> (d0)>
// CHECK_GEN:   #map1 = affine_map<(d0, d1, d2) -> (d2, d1)>
// CHECK_GEN:   #map2 = affine_map<(d0, d1, d2) -> (d0, d1)>
// CHECK_GEN:   "builtin.module"() ({
// CHECK_GEN:       "func.func"() <{function_type = (memref<3xf32>, memref<5x7xf32>) -> memref<3x7xf32>, sym_name = "test"}> ({
// CHECK_GEN:       ^bb0(%arg0: memref<3xf32>, %arg1: memref<5x7xf32>):
...
// CHECK_GEN:           }) {linalg.memoized_indexing_maps = [#map, #map1, #map2]} : (memref<3xf32>, memref<5x7xf32>, memref<3x7xf32>) -> ()
// CHECK_GEN:           "func.return"(%0) : (memref<3x7xf32>) -> ()
// CHECK_GEN:       }) : () -> ()
// CHECK_GEN:   }) : () -> ()

// CHECK_AFF:   module {
// CHECK_AFF:       func.func @test(%arg0: memref<3xf32>, %arg1: memref<5x7xf32>) -> memref<3x7xf32> {
...
// CHECK_AFF:                       %0 = affine.load %arg0[%arg2] : memref<3xf32>
