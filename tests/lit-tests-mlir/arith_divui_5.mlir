...
module {
    ...
    {
        %out = arith.divui %a, %b : tensor<10xi32>
...
// CHECK_CAN:           %0 = arith.divui %arg0, %arg1 : tensor<10xi32>
...
// CHECK_GEN:           %0 = "arith.divui"(%arg0, %arg1) : (tensor<10xi32>, tensor<10xi32>) -> tensor<10xi32>
