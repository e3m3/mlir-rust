...
module {
    func.func @test(%a: memref<8x16xi64>, %b: memref<8x16xi64>) -> memref<8x16xi64>
    {
        ...
        linalg.div ins(%a, %b: memref<8x16xi64>, memref<8x16xi64>) outs(%out: memref<8x16xi64>)
...
// CHECK_CAN:           linalg.div ins(%arg0, %arg1 : memref<8x16xi64>, memref<8x16xi64>) outs(%alloc : memref<8x16xi64>)
...
// CHECK_GEN:               %1 = "arith.divsi"(%arg2, %arg3) : (i64, i64) -> i64
