...
module {
    ...
    {
        %low, %high = arith.mului_extended %a, %b : vector<10xi8>
...
// CHECK_CAN:           %low, %high = arith.mului_extended %arg0, %arg1 : vector<10xi8>
...
// CHECK_GEN:           %0:2 = "arith.mului_extended"(%arg0, %arg1) : (vector<10xi8>, vector<10xi8>) -> (vector<10xi8>, vector<10xi8>)
