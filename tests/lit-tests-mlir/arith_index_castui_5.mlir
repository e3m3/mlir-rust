...
module {
    ...
    {
        %out = arith.index_castui %in : tensor<10xi32> to tensor<10xindex>
...
// CHECK_CAN:           %0 = arith.index_castui %arg0 : tensor<10xi32> to tensor<10xindex>
...
// CHECK_GEN:           %0 = "arith.index_castui"(%arg0) : (tensor<10xi32>) -> tensor<10xindex>
