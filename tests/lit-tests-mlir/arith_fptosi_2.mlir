...
module {
    ...
    {
        %out = arith.fptosi %in : vector<10xf64> to vector<10xi64>
...
// CHECK_CAN:           %0 = arith.fptosi %arg0 : vector<10xf64> to vector<10xi64>
...
// CHECK_GEN:           %0 = "arith.fptosi"(%arg0) : (vector<10xf64>) -> vector<10xi64>
