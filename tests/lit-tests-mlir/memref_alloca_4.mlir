...
// CHECK_CAN:           %alloca = memref.alloca()[%arg0] {alignment = 8 : i64} : memref<8x64xf32, #map>
...
// CHECK_GEN:           %0 = "memref.alloca"(%arg0) <{alignment = 8 : i64, operandSegmentSizes = array<i32: 0, 1>}> : (index) -> memref<8x64xf32, #map>
