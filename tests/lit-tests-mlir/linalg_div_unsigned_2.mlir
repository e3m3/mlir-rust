...
module {
    func.func @test(%a: memref<8x16xi64>, %b: memref<8x16xi64>) -> memref<8x16xi64>
    {
        ...
        linalg.div_unsigned ins(%a, %b: memref<8x16xi64>, memref<8x16xi64>) outs(%out: memref<8x16xi64>)
...
// CHECK_CAN:           linalg.div_unsigned ins(%arg0, %arg1 : memref<8x16xi64>, memref<8x16xi64>) outs(%alloc : memref<8x16xi64>)
...
// CHECK_GEN:           "linalg.div_unsigned"(%arg0, %arg1, %0) <{operandSegmentSizes = array<i32: 2, 1>}> ({
// CHECK_GEN:           ^bb0(%arg2: i64, %arg3: i64, %arg4: i64):
// CHECK_GEN:               %1 = "arith.divui"(%arg2, %arg3) : (i64, i64) -> i64
