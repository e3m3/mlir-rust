...
module {
    ...
    {
        %out = arith.addi %a, %b : vector<10xi32>
...
// CHECK_CAN:           %0 = arith.addi %arg0, %arg1 : vector<10xi32>
...
// CHECK_GEN:           %0 = "arith.addi"(%arg0, %arg1) <{overflowFlags = #arith.overflow<none>}> : (vector<10xi32>, vector<10xi32>) -> vector<10xi32>
