...
module {
    ...
    {
        %out = arith.subi %a, %b {overflowFlags = #arith.overflow<nsw>} : vector<10xindex>
...
// CHECK_CAN:           %0 = arith.subi %arg0, %arg1 overflow<nsw> : vector<10xindex>
...
// CHECK_GEN:           %0 = "arith.subi"(%arg0, %arg1) <{overflowFlags = #arith.overflow<nsw>}> : (vector<10xindex>, vector<10xindex>) -> vector<10xindex>
