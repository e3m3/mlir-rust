...
module {
    func.func @test(%a: tensor<8x16xf32>, %b: tensor<8x16xf32>) -> tensor<8x16xf32>
    {
        ...
        %out0 = linalg.add ins(%a, %b: tensor<8x16xf32>, tensor<8x16xf32>) outs(%out: tensor<8x16xf32>) -> tensor<8x16xf32>
...
// CHECK_CAN:           %1 = linalg.add ins(%arg0, %arg1 : tensor<8x16xf32>, tensor<8x16xf32>) outs(%0 : tensor<8x16xf32>) -> tensor<8x16xf32>
...
// CHECK_GEN:               %2 = "arith.addf"(%arg2, %arg3) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
