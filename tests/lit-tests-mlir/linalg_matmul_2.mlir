...
module {
    func.func @test(%a: memref<5x3xf32>, %b: memref<5x7xf32>) -> memref<3x7xf32>
    {
        ...
        ] } ins(%a, %b: memref<5x3xf32>, memref<5x7xf32>) outs(%out: memref<3x7xf32>)
...
// CHECK_CAN:           linalg.matmul ins(%arg0, %arg1 : memref<5x3xf32>, memref<5x7xf32>) outs(%alloc : memref<3x7xf32>)
