...
module {
    func.func @test(%a: memref<8x16xf32>, %b: memref<8x16xf32>) -> memref<8x16xf32>
    {
        ...
        linalg.mul ins(%a, %b: memref<8x16xf32>, memref<8x16xf32>) outs(%out: memref<8x16xf32>)
...
// CHECK_CAN:           linalg.mul ins(%arg0, %arg1 : memref<8x16xf32>, memref<8x16xf32>) outs(%alloc : memref<8x16xf32>)
