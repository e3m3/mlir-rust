...
module {
    ...
    {
        %out = arith.divui %a, %b : vector<10xindex>
...
// CHECK_CAN:           %0 = arith.divui %arg0, %arg1 : vector<10xindex>
...
// CHECK_GEN:           %0 = "arith.divui"(%arg0, %arg1) : (vector<10xindex>, vector<10xindex>) -> vector<10xindex>
