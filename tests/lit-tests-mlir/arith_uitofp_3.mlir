...
module {
    ...
    {
        %out = arith.uitofp %in : tensor<10xi64> to tensor<10xf64>
...
// CHECK_CAN:           %0 = arith.uitofp %arg0 : tensor<10xi64> to tensor<10xf64>
...
// CHECK_GEN:           %0 = "arith.uitofp"(%arg0) : (tensor<10xi64>) -> tensor<10xf64>
