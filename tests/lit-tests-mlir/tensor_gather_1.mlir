...
// CHECK_CAN:           %gather = tensor.gather %arg0[%arg1] gather_dims([0, 1, 2]) : (tensor<4x4x4xf32>, tensor<1x2x3xindex>) -> tensor<1x2x1x1x1xf32>
...
// CHECK_GEN:           %0 = "tensor.gather"(%arg0, %arg1) <{gather_dims = array<i64: 0, 1, 2>}> : (tensor<4x4x4xf32>, tensor<1x2x3xindex>) -> tensor<1x2x1x1x1xf32>
