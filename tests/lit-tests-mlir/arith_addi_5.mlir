...
module {
    ...
    {
        %out = arith.addi %a, %b : tensor<10xi32>
...
// CHECK_CAN:           %0 = arith.addi %arg0, %arg1 : tensor<10xi32>
...
// CHECK_GEN:           %0 = "arith.addi"(%arg0, %arg1) <{overflowFlags = #arith.overflow<none>}> : (tensor<10xi32>, tensor<10xi32>) -> tensor<10xi32>
