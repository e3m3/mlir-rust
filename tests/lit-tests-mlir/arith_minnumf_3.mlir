...
module {
    ...
    {
        %out = arith.minnumf %a, %b : tensor<4xf64>
...
// CHECK_CAN:           %0 = arith.minnumf %arg0, %arg1 : tensor<4xf64>
...
// CHECK_GEN:           %0 = "arith.minnumf"(%arg0, %arg1) <{fastmath = #arith.fastmath<none>}> : (tensor<4xf64>, tensor<4xf64>) -> tensor<4xf64>
