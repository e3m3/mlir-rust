...
module {
    ...
    {
        %low, %high = arith.mului_extended %a, %b : tensor<10xi8>
...
// CHECK_CAN:           %low, %high = arith.mului_extended %arg0, %arg1 : tensor<10xi8>
...
// CHECK_GEN:           %0:2 = "arith.mului_extended"(%arg0, %arg1) : (tensor<10xi8>, tensor<10xi8>) -> (tensor<10xi8>, tensor<10xi8>)
