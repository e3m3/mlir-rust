...
module {
    ...
    {
        %out = arith.index_castui %in : tensor<10xindex> to tensor<10xi32>
...
// CHECK_CAN:           %0 = arith.index_castui %arg0 : tensor<10xindex> to tensor<10xi32>
...
// CHECK_GEN:           %0 = "arith.index_castui"(%arg0) : (tensor<10xindex>) -> tensor<10xi32>
