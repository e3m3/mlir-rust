...
module {
    ...
    {
        %out = arith.index_castui %in : vector<10xindex> to vector<10xi32>
...
// CHECK_CAN:           %0 = arith.index_castui %arg0 : vector<10xindex> to vector<10xi32>
...
// CHECK_GEN:           %0 = "arith.index_castui"(%arg0) : (vector<10xindex>) -> vector<10xi32>
