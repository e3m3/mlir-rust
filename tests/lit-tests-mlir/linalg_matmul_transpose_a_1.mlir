...
module {
    func.func @test(%a: memref<5x3xf32>, %b: memref<5x7xf32>) -> memref<3x7xf32>
    {
        %out = memref.alloc() : memref<3x7xf32>
        linalg.matmul_transpose_a ins(%a, %b: memref<5x3xf32>, memref<5x7xf32>) outs(%out: memref<3x7xf32>)
        func.return %out : memref<3x7xf32>
    }
}

// CHECK_CAN:   module {
// CHECK_CAN:       func.func @test(%arg0: memref<5x3xf32>, %arg1: memref<5x7xf32>) -> memref<3x7xf32> {
// CHECK_CAN:           %alloc = memref.alloc() : memref<3x7xf32>
// CHECK_CAN:           linalg.matmul_transpose_a ins(%arg0, %arg1 : memref<5x3xf32>, memref<5x7xf32>) outs(%alloc : memref<3x7xf32>)
...
// CHECK_GEN:       "func.func"() <{function_type = (memref<5x3xf32>, memref<5x7xf32>) -> memref<3x7xf32>, sym_name = "test"}> ({
// CHECK_GEN:       ^bb0(%arg0: memref<5x3xf32>, %arg1: memref<5x7xf32>):
// CHECK_GEN:           %0 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<3x7xf32>
// CHECK_GEN:           "linalg.matmul_transpose_a"(%arg0, %arg1, %0) <{operandSegmentSizes = array<i32: 2, 1>}> ({
...
// CHECK_GEN:           }) {linalg.memoized_indexing_maps = [#map, #map1, #map2]} : (memref<5x3xf32>, memref<5x7xf32>, memref<3x7xf32>) -> ()
// CHECK_GEN:           "func.return"(%0) : (memref<3x7xf32>) -> ()
// CHECK_GEN:       }) : () -> ()
// CHECK_GEN:   }) : () -> ()

// CHECK_AFF:   module {
// CHECK_AFF:       func.func @test(%arg0: memref<5x3xf32>, %arg1: memref<5x7xf32>) -> memref<3x7xf32> {
...
// CHECK_AFF:                       %1 = affine.load %arg1[%arg4, %arg3] : memref<5x7xf32>
