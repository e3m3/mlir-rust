...
module {
    func.func @test(%a: tensor<8x16xf32>, %b: tensor<8x16xf32>) -> tensor<8x16xf32>
    {
        ...
        %out0 = linalg.sub ins(%a, %b: tensor<8x16xf32>, tensor<8x16xf32>) outs(%out: tensor<8x16xf32>) -> tensor<8x16xf32>
...
// CHECK_CAN:           %1 = linalg.sub ins(%arg0, %arg1 : tensor<8x16xf32>, tensor<8x16xf32>) outs(%0 : tensor<8x16xf32>) -> tensor<8x16xf32>
...
// CHECK_GEN:               %2 = "arith.subf"(%arg2, %arg3) <{fastmath = #arith.fastmath<none>}> : (f32, f32) -> f32
