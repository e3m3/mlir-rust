...
module {
    ...
    {
        %out = arith.extsi %in : tensor<10xi32> to tensor<10xi64>
...
// CHECK_CAN:           %0 = arith.extsi %arg0 : tensor<10xi32> to tensor<10xi64>
...
// CHECK_GEN:           %0 = "arith.extsi"(%arg0) : (tensor<10xi32>) -> tensor<10xi64>
