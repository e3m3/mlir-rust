...
module {
    ...
    {
        %out = arith.divui %a, %b : tensor<10xindex>
...
// CHECK_CAN:           %0 = arith.divui %arg0, %arg1 : tensor<10xindex>
...
// CHECK_GEN:           %0 = "arith.divui"(%arg0, %arg1) : (tensor<10xindex>, tensor<10xindex>) -> tensor<10xindex>
