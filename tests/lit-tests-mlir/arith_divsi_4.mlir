...
module {
    ...
    {
        %out = arith.divsi %a, %b : vector<10xindex>
...
// CHECK_CAN:           %0 = arith.divsi %arg0, %arg1 : vector<10xindex>
...
// CHECK_GEN:           %0 = "arith.divsi"(%arg0, %arg1) : (vector<10xindex>, vector<10xindex>) -> vector<10xindex>
