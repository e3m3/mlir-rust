...
module {
    ...
    {
        %out = arith.muli %a, %b {overflowFlags = #arith.overflow<nsw>} : index
...
// CHECK_CAN:           %0 = arith.muli %arg0, %arg1 overflow<nsw> : index
...
// CHECK_GEN:           %0 = "arith.muli"(%arg0, %arg1) <{overflowFlags = #arith.overflow<nsw>}> : (index, index) -> index
